...
public class AccountTransaction : ICloneable
{
    ...
    public AccountTransaction(long id, string description, string transType, DateTime transactionDate,
        DateTime? reconciliationDate, decimal amount, string checkNumber)
    {
        Id = id;
    ...
    public object Clone()
    {
        return new AccountTransaction(Id, Description, TransType, TransactionDate, ReconciliationDate, Amount,
            CheckNumber);
    }
